...
// NEW: monster poof animation (position + 0f..1f)
    ...
    Scaffold(
        ...
        //making a nice whole background picture
        Box(
            modifier = Modifier
                .fillMaxSize()
        ) {
            ...
            Column(
                ...
                val latestFunctionId = userFunctions.lastOrNull()?.id
                        ...
                        onClick = {
                            ...
                            scope.launch {
                                        ...
                                        if (cmd == Command.ATTACK) {
                                            ...
                                            if (dir != null) {
                                                ...
                                                continueSlide@ while (true) {
                                                    ...
                                                    val isInner =
                                                        gameMap.walls.contains(nextX to nextY)
                                                    val isWater =
                                                        gameMap.waterTiles.contains(nextX to nextY)
                                                    ...
                                                    val isPitTile =
                                                        tileId == "pit_top" || tileId == "pit_bottom"
                                                    val isButtonTile =
                                                        tileId == "button_unpressed" ||
                                                                tileId == "button_pressed" ||
                                                                tileId == "button"

                                                    val isPit = pitTiles.contains(nextX to nextY)
                                                    val isButton =
                                                        buttonTiles.contains(nextX to nextY)
                                                    val isMonsterNext =
                                                        monsterTiles.contains(nextX to nextY)
                                                    ...
                                                    if (isPitTile && !buttonPressed) {
                                                        ...
                                                        resultTitle = "Pitfall!"
                                                        resultBody =
                                                            "The pit was still open. Try pressing the button first."
                                                        isSuccessResult = false
                                                        runResultCode = "PIT"
                                                    ...
                                                    if (isWater) {
                                                        ...
                                                        resultTitle = "Splash!"
                                                        resultBody =
                                                            "Link fell into the water. Try a different program."
                                                        isSuccessResult = false
                                                        runResultCode = "WATER"
                                                        showResultDialog = true
                                                        isRunning = false
                                                        touchedWater =
                                                            true      // ← match your main slide logic if you do this there
                                                        break@continueSlide
                                                    }
                                    ...
                                    slideLoop@ while (true) {
                                        ...
                                        if (isOuter || isInner) {
                                            if (!movedThisCommand) {
                                                ...
                                                resultBody =
                                                    "Your program tried to move Link into a wall. Try a different set of commands."
                                                isSuccessResult = false
                                ...
                                if (!showResultDialog) {
                                    ...
                                    statusMessage =
                                        "Program finished, but Link did not reach the goal."
                                    resultTitle = "Try Again"
                                    resultBody =
                                        "All commands ran, but Link never reached the goal."
                                    isSuccessResult = false
                                    ...
                                    functionSlots.forEachIndexed { index, slotCmd ->
                                        Box(
                                            modifier = Modifier
                                                ...
                                                .border(
                                                    width = 2.dp,
                                                    color = if (slotCmd == null) Color.DarkGray else Color(
                                                        0xFF6ABE30
                                                    ),
